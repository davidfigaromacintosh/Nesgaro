...
#define IMMEDIATE	3	//Immediate
#define IMPLIED		4	//Implied

//Nieindeksowane, wymagaj¹ dostêpu do pamiêci
//#define RELATIVE	2	//Relative
//#define ABSOLUTE	1	//Absolute
...
namespace CPU {
	...
	u8 opcodeCycle[] = {
		...
		2, 5, 8, 8, 8, 4, 6, 8, 2, 4, 8, 8, 8, 4, 7, 8,
		6, 6, 8, 8, 8, 3, 5, 8, 3, 2, 2, 8, 3, 4, 6, 8,
		2, 5, 8, 8, 8, 4, 6, 8, 2, 4, 8, 8, 8, 4, 7, 8,
		6, 6, 8, 8, 8, 3, 5, 8, 4, 2, 2, 8, 5, 4, 6, 8,
		6, 5, 8, 8, 8, 4, 6, 8, 2, 4, 8, 8, 8, 4, 7, 8,
		8, 6, 8, 8, 3, 3, 3, 8, 2, 8, 2, 8, 4, 4, 4, 8,
		2, 6, 8, 8, 4, 4, 4, 8, 2, 5, 2, 8, 8, 5, 8, 8,
		2, 6, 2, 8, 3, 3, 3, 8, 2, 2, 2, 8, 4, 4, 4, 8,
		2, 5, 8, 8, 4, 4, 4, 8, 2, 4, 2, 8, 4, 4, 4, 8,
		2, 6, 8, 8, 3, 3, 5, 8, 2, 2, 2, 8, 4, 4, 6, 8,
		2, 5, 8, 8, 8, 4, 6, 8, 2, 4, 8, 8, 8, 4, 7, 8,
		2, 6, 8, 8, 3, 3, 5, 8, 2, 2, 2, 2, 4, 4, 6, 8,
		2, 5, 8, 8, 8, 4, 6, 8, 2, 4, 8, 8, 8, 4, 7, 8
	};
