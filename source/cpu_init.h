...
//Maski wszystkich "legalnych" instrukcji (PS: okazało się, że nie będę tego potrzebował, więc okomentowałem)
/*
...
//Typy przerwań (NMI, IRQ, BRK)
#define	INT_NMI	0
#define	INT_IRQ	1
#define	INT_BRK	2

//Grupy bitów (maska grupy 4 to po prostu 0 więc nie definiujemy)
...
#define ADDRMODE_ERROR 13 //Błąd odczytu trybu adresowania lub nielegalna instrukcja

/*
Wszystkie potrzebne informacje znalazłem tu:
...
architektura mikroprocesora MOS Technology 6502 z jednym wyjątkiem:
Ricoh 2A03 nie wspiera trybu dziesiętnego.
*/
...
namespace CPU {
	...
	u8 X;		//Rejestr X
	u8 Y;		//Rejsetr Y
	u8 P;		//0bNV1BDIZC (Flagi C, Z, I, D, flaga czwarta i piąta są pozorne, V, N)
	u8 S;		//Wskaźnik stosu
...
/*	u8 opcodeCycle[256] = {
	...
	*/
	...
	//Tutaj zaczyna się wykonywanie instrukcji
	void execute();
